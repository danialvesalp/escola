...
// Database
import Database_Escola_db from "./Database_Escola_db.js";

// Controllers
import UserController from "../controllers/Escola_db/UserController";
import CursoController from "../controllers/Escola_db/CursoController";
import EstudanteController from "../controllers/Escola_db/EstudanteController";
import ProfessorController from "../controllers/Escola_db/ProfessorController";
import ProvaController from "../controllers/Escola_db/ProvaController";
...
class Server {
 ...
 // End Init Database
    ...
    // Start Init Controllers
		...
		CursoController.init(router);
		EstudanteController.init(router);
		ProfessorController.init(router);
		ProvaController.init(router);
